...
export const metadata = {
    title: "Contact",
    description: "Contact Details for Dike Wisdom",
};
...
export default function Contact() {
    return (
        <>
            ...
            <PageHero PageProps={{link: "/contact", title: "Contact"}}/>
            <section className="text-gray-600 body-font relative short_section">
